    ...
    <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-30">
        <div>
          ...
          <h4 class="mg-b-0 tx-spacing--1">Master Pencantuman Gelar</h4>
        </div>
      ...
      <div class="col-lg-4 col-xl-12 mg-t-10">
        <div class="card">
          <div class="card-header pd-t-20 pd-b-0 bd-b-0">
            ...
            @endif
            <h6 class="mg-b-5">Daftar Permohonan Pencantuman Gelar</h6>
            <p class="tx-12 tx-color-03 mg-b-0">Daftar Permohonan Pencantuman Gelar yang telah diinput.</p>
