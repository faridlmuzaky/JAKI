    ...
    <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-30">
        ...
        <div class="d-flex justify-content-end">
          ...
          <a href="{{url('/approvalcuti')}}" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5"><i data-feather="arrow-left" class="wd-10 mg-r-5"></i> Back</a>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-xl-12 mg-t-10">
        ...
        <div class="row">
            <div class="col-md- col-lg-7 order-md-last">
              <form method="POST" action="/approvalcutikepeg/{{$cuti->id_detail}}/proses" class="needs-validation" enctype="multipart/form-data">
                ...
                <ul class="list-group mb-3">
                  ...
                  <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                      <h6 class="my-0">Atasan Langsung Pemohon</h6>
				...
				{{ $cuti->atasan_langsung == $user->username ? 'selected' : ''}}
			    >
                  ...
                  <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                        <h6 class="my-0">PPK (Pejabat Berwenang)</h6>
                        <select class="custom-select @error ('ppk') is-invalid @enderror" name="ppk">
                            <option value="" selected>- Silahkan Pilih -</option>
                            @foreach ($user2 as $user2)
                                <option value="{{$user2->username}}-{{$user2->name}}"
				    {{ $cuti->pejabat_berwenang == $user2->username ? 'selected' : ''}}
				>
				    {{$user2->name ." - ". $user2->jabatan }}
				</option>
                            @endforeach
			...
			@if ($cuti->id_satker==28)
		    	    <h4 class="d-flex justify-content-between align-items-center mb-3">
                                <span class="text-muted">Informasi Pengajuan Cuti</span>
                                <span class="badge badge-danger">pegawai = {{ $jml_pegawai }} | 30% = {{ ($jml_pegawai * 30)/100 }}</span>
                            </h4>
                            ...
                            <ul class="list-group mb-3">
                                <li class="list-group-item d-flex justify-content-between lh-sm">
                                    ...
                                    <span class="my-0">
                                        <h6 class="my-0">Jumlah Pengajuan</h6>
                                    </span>
                                </li>
