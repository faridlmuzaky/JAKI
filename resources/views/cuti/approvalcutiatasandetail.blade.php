        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
              ...
              <li class="breadcrumb-item active" aria-current="page">Persetujuan Atasan Usul Cuti</li>
            </ol>
          </nav>
          <h4 class="mg-b-0 tx-spacing--1">Persetujuan Atasan Usul Cuti</h4>
        </div>
      ...
      <div class="col-lg-4 col-xl-12 mg-t-10">
        ...
        <div class="row">
            <div class="col-md- col-lg-7 order-md-last">
              <form method="POST" action="/approvalcutiatasandetail/{{$cuti->id_detail}}/proses" class="needs-validation" enctype="multipart/form-data">
