     ...
     {{-- <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0"> --}}
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-30">
        ...
        <div class="d-flex justify-content-end">     
          ...
          <a href="{{url('/addusulctuser')}}" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5"><i data-feather="plus" class="wd-10 mg-r-5"></i> Tambah Usulan</a>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  ...
                                  <a class="dropdown-item" href="{{url('/cetakcuti/')}}/{{$item->id_detail}}"><i data-feather="printer" class="wd-15 mg-r-5"></i>Cetak Permohonan</a>
                                  {{-- <a class="dropdown-item" href="" data-toggle="modal" data-target="#Modal{{$item->id_detail}}"><i data-feather="upload" class="wd-15 mg-r-5"></i>Kirim Permohonan</a> --}}
                                  <div class="dropdown-divider"></div>
                                  ...
                                  @if ($item->dok_persetujuan)
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="{{asset('images').'/'.$item->dok_persetujuan}}" target="_blank"><i data-feather="download" class="wd-15 mg-r-5"></i>Download Persetujuan</a>
                                  @endif
                                </div>
                              </div>
