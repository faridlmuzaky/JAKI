@extends('layout.main')
@section('title', 'Approval Cuti Ketua/PPK')
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  ...
                                  <a class="dropdown-item" href="/approvalcutippkdetail/{{$item->id_detail}}/proses"><i data-feather="check-square" class="wd-15 mg-r-5"></i>Proses</a>
