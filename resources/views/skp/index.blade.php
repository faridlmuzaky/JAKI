    ...
    {{-- <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0"> --}}
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-30">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ url('/skp/add_skp/peg') }}" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5">
                        ...
                        <table class="table mt-3" id="tabel">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ url('/skp/download/') }}/{{ encrypt($skp->id) }}" target="_blank">{{ $skp->name }}</a>
                                        @if ($skp->file_ttd_kpta)
                                        <a href="#" class="badge badge-success">Sudah di TTE</a>
                                        @endif
                                    </td>
                                    <td>
                                        {{ $skp->bantu ? $skp->jabatan . ' (Perbantuan)' : $skp->jabatan }} <br/>
                                        {{ $skp->bantu ? $skp->bantu : $skp->nama_satker }}
                                    </td>
...
<script>
    ...
    function filter() {
        ...
        var url = 'skp?tahun=' + tahun + '&periode=' + periode;
