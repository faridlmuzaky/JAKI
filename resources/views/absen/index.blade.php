          ...
          <div class="card-body pd-20">
              ...
              <input type="text" name="lokasinya" id="lokasinya" class="form-control" hidden placeholder="First name" >
                ...
                <button type="submit" @if ($time<1630 || $time>2000 ) disabled @endif name="submit" value="btnOut" class="btn btn-sm pd-x-15 btn-success btn-uppercase mg-l-5 mb-2"><i data-feather="log-out" class="wd-10 mg-r-5"></i> Isi Absensi Pulang</button>
                 --}}
                <button type="submit"  name="submit" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 mb-2" value="btnIn"><i data-feather="log-in" class="wd-10 mg-r-5"></i> Isi Absensi Masuk</button>
                <button type="submit"  name="submit" class="btn btn-sm pd-x-15 btn-warning btn-uppercase mg-l-5 mb-2" value="btnBreak"><i data-feather="at-sign" class="wd-10 mg-r-5"></i> Isi Absensi Istirahat</button>
                <button type="submit" name="submit" value="btnOut" class="btn btn-sm pd-x-15 btn-success btn-uppercase mg-l-5 mb-2"><i data-feather="log-out" class="wd-10 mg-r-5"></i> Isi Absensi Pulang</button>
