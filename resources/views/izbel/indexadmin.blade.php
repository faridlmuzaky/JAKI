@extends('layout.main')
@section('title', 'Proses Izin Belajar')
        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
              ...
              <li class="breadcrumb-item active" aria-current="page">Proses Izin Belajar</li>
            </ol>
          </nav>
          <h4 class="mg-b-0 tx-spacing--1">Proses Permohonan Izin Belajar</h4>
        </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  <a class="dropdown-item" href="/izbel/{{$item->id}}/proses"><i data-feather="repeat" class="wd-15 mg-r-5"></i>Proses Permohonan</a>
                                  <a class="dropdown-item" href="/izbel/{{$item->id}}/kunciizbel"><i data-feather="lock" class="wd-15 mg-r-5"></i>Kunci Permohonan</a>
                                  <a class="dropdown-item" href="/izbel/{{$item->id}}/produk"><i data-feather="upload" class="wd-15 mg-r-5"></i>Upload Produk</a>
                                  <div class="dropdown-divider"></div>
                                  <a class="dropdown-item" href="/izbel/{{$item->id}}/history"><i data-feather="clock" class="wd-15 mg-r-5"></i>History Usulan</a>
                                  {{-- <a class="dropdown-item" href="/izbel/{{$item->id}}/waizbel"><i data-feather="send" class="wd-15 mg-r-5"></i>Kirim Whatsapp</a> --}}
                                  {{-- <a class="dropdown-item" href="/izbel/{{$item->id}}/edit">Surat Pernyataan</a>
                                  <a class="dropdown-item" href="/izbel/{{$item->id}}/edit">Surat Persetujuan</a> --}}
                                  {{-- <div class="dropdown-divider"></div>
