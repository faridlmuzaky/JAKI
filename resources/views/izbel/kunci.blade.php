    ...
    <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-30">
        <div>
          ...
          <h4 class="mg-b-0 tx-spacing--1">Kunci Permohonan Izin Belajar</h4>
        </div>
      ...
      <div class="col-lg-4 col-xl-12 mg-t-10">
        <div class="card">
          <div class="card-header pd-t-20 pd-b-0 bd-b-0">
            <h6 class="mg-b-5">Kunci Permohonan</h6>
            <p class="tx-12 tx-color-03 mg-b-0">Kunci permohonan izin belajar</p>
          </div><!-- card-header -->
          <div class="card-body pd-20">
            
            <form method="POST" action="/izbel/{{$izbel->id}}/proseskunci" class="needs-validation" enctype="multipart/form-data">
              @csrf
                ...
                @if ($izbel->status_kunci =='1')
                    <input type="hidden" value="1" name="isi">
                    <button type="submit" class="btn btn-secondary"><i data-feather="unlock" class="wd-20 mg-r-5"></i>Buka Kunci Permohonan</button>

                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cetakModal"><i data-feather="printer" class="wd-20 mg-r-5"></i>Cetak Surat Pengantar/Keputusan</button>
                @endif
              </form>
