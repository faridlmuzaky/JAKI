        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
              ...
              <li class="breadcrumb-item active" aria-current="page">Laporan Presensi Apel</li>
            </ol>
          </nav>
          <h4 class="mg-b-0 tx-spacing--1">Laporan Presensi Apel</h4>
        </div>
      ...
      <div class="col-lg-4 col-xl-12 mg-t-10">
        <div class="card ">
          <div class="card-header pd-t-20 pd-b-0 bd-b-0">
            ...
            @endif
            <h6 class="mg-b-5">Laporan  Presensi Apel</h6>
            ...
            <form id="form1" method="POST" action="{{ url('/carilaporanapel') }}" enctype="multipart/form-data">
              @csrf
