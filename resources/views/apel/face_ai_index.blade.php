        ...
        <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
            ...
            <form method="POST" action="/apel">
                ...
                >
                    ...
                    <div class="row col-md-12">
                        <a href="#" id="btn-swafoto" onClick="take_snapshot()"
                                    class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 mb-2"><i data-feather="camera"
                                        class="wd-10 mg-r-5"></i> Ambil Swafoto</a>

                                <button type="submit" name="submit" id="btn-submit" disabled
                                ...
                                <tbody>
                                    @foreach ($Absen as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->foto)
                                                <img src="data:image/jpeg;base64,{{ $item->foto }}" style="width: 80px;"/>
                                                @endif
                                            </td>
                                            <td>{{ $item->face_message }}</td>
                                        </tr>
                                    @endforeach
    ...
    <script>
        ...
        function take_snapshot() {
            Webcam.snap(function(data_uri) {
                var base64 = data_uri.replace('data:image/jpeg;base64,', '');
                $("#base64").val(base64);
                document.getElementById('results').innerHTML = '<img src="' + data_uri + '" style="width: 400px; height: 300px;"/>';
                $("#my_camera").hide();
                $("#results").show();
