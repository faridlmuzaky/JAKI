...
Route::middleware(['auth:sanctum', 'verified'])->get('/user/{id}/edit', [UserController::class, 'edit']);
Route::middleware(['auth:sanctum', 'verified'])->get('/user/{id}/edituser', [UserController::class, 'edituser']);
Route::middleware(['auth:sanctum', 'verified'])->post('/user/{id}/update', [UserController::class, 'update']);
Route::middleware(['auth:sanctum', 'verified'])->post('/user/{id}/updateuser', [UserController::class, 'updateuser']);
Route::middleware(['auth:sanctum', 'verified'])->get('/user/{id}/delete', [UserController::class, 'destroy']);
...
// route ST
Route::middleware(['auth:sanctum', 'verified', 'CekAdmin:1'])->get('/surattugas', [SuratTugasController::class, 'index']);
...
Route::middleware(['auth:sanctum', 'verified'])->get('/add_pck', [PckController::class, 'add'])->name('add_pck');
